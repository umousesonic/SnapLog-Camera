...
class CameraPin {
    public:
    // ------------ Our Design -------------------
        // static const int PWDN_GPIO_NUM =    14;
        // static const int RESET_GPIO_NUM =   15;
        // static const int XCLK_GPIO_NUM =    26;
        // static const int SIOD_GPIO_NUM =    12;
        // static const int SIOC_GPIO_NUM =    13;

        // static const int Y9_GPIO_NUM =      35;
        // static const int Y8_GPIO_NUM =      34;
        // static const int Y7_GPIO_NUM =      33;
        // static const int Y6_GPIO_NUM =      32;
